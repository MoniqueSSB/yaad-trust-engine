  ...
  return (
    <div className="mx-auto max-w-[420px]">
      ...
      {ok ? (
        ...
        <Link
          href="/portal/forgot"
          className="mt-5 inline-flex rounded-full bg-linear-to-r from-teal to-mango px-5 py-2.5 text-[13px] font-bold text-onbrand transition hover:brightness-110"
        >
          Send me a new link
        </Link>
      )}
