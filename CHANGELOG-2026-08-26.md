...
against 12 real spellings including the Kingston 5–10 → `st andrew` case.
...
| | Was | Now | Why |
|---|---|---|---|
| Visual Check | £25 / £45 | **£149** | Those were the inspection ladder's internal cost lines, not a client price. UK property inspection report is £80–150. |
| Condition Report | £249 | **£325** | RICS Level 1 is £300–900 |
...
| Full Project Management | 8–15% | **12–15%, min £2,500** | Decided 13 Aug, was mis-stated |
...
- **Fee stacking** — Full PM at 12–15% against a UK norm of 8–15% for *all* professional fees.
