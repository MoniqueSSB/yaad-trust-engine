...
set -euo pipefail
cd "$(dirname "$0")"
for d in yaad-agent yaad-vision yaad-whatsapp-webhook yaad-website-intake yaad-kickoff yaad-completion yaad-portal-signup; do  # yaad-match has no otel import
