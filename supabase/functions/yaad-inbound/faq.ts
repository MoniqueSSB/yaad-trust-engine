...
- For tradespeople: joining is free, quoting is free, and there is never a charge for a lead. The price is agreed per job, in writing, before starting; materials money is sent at cost to buy the goods once the client has paid for them, and the receipt comes back afterwards. Paid by Yaadly, not by the client, within 7 working days of a named person at Yaadly signing the stage off, by bank transfer. Yaadly does not pay in cash. Join at app.yaadly.co.uk/apply, or by answering five short questions on WhatsApp with a photo of a finished job.
