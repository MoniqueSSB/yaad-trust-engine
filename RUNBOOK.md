...
3. **A row says the check could not be read.** The migration is not applied yet, or the session expired. Sign in again; if it persists, check `20260917180000` is in `schema_migrations`.
